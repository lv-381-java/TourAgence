...
//                preparedStatement.setDate(4, orderDetails.getEndDate());
    ...
    @Override
    public List<OrderDetails> selectAll() throws SQLException {
        ...
        if (connection != null) {
            ...
            ResultSet resultSet = statement.executeQuery(selectAllOrderDetails);
    ...
    @Override
    public OrderDetails selectById(Long id) throws SQLException {
    ...
    public List<OrderDetails> selectOrderFromAllOrders(Long id) throws SQLException {
    ...
    @Override
    public void updateById(OrderDetails orderDetails, Long id) throws SQLException {
